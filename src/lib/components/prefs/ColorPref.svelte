<script lang="ts">
	...
	const title = {
		accent: m.colorPref_title_accent,
		primary: m.colorPref_title_primary
	}[category];

	const selectOptions: Array<'custom' | DefaultColor> = [
		'custom',
		...(Object.keys(defaultColors) as DefaultColor[])
	];
	...
	} satisfies Record<'custom' | DefaultColor, () => string>;
...
<div class="flex items-center">
	...
	<Select
		...
		items={selectItems(selectOptions, (item) => optionLabel[item as 'custom' | DefaultColor]())}
	>
