...
<Dialog bind:open title={m.aboutDialog_title()}>
	...
	<div>
		...
		<p class="text-primary-300">
			...
			<br />
			Built on Gale under GNU General Public License v3.0
		</p>
		...
		<div class="mt-1 flex items-center gap-2">
			...
			<Link href={brand.upstreamRepo}>Source base: {brand.upstreamName}</Link>
		</div>
		<div class="mt-1 flex items-center gap-2">
			<Icon icon="mdi:discord" class="text-xl text-white" />
			<Link href={brand.communityUrl}>Community</Link>
		</div>
		<div class="mt-1 flex items-center gap-2">
